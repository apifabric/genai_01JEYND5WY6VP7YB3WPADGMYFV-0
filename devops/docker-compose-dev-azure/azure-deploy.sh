...
resourcename="ordermanagementsystem"  # lower case, only
resourcegroup="ordermanagementsystem_rg"
...
# git clone https://github.com/apilogicserver/ordermanagementsystem.git
...
az group create --name ordermanagementsystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group ordermanagementsystem_rg --sku S1 --is-linux
az container create --resource-group ordermanagementsystem_rg --name ordermanagementsystem --image apilogicserver/ordermanagementsystem:latest --dns-name-label ordermanagementsystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//ordermanagementsystem.westus.azurecontainer.io:5656'
